...
function toggleColors() {
  ...
  let whiteClass = document.querySelectorAll(".tm-white-rect");

  whiteClass.forEach(function (single) {
    single.className = "d-inline-block tm-blue-rect";
  });

  // whiteClass.className = '.tm-blue-rect';
}

function hideElement() {
  //<ul class="nav flex-row tm-social-links">  <!--todo: Hide social links-->
  var links = document.querySelector(".tm-social-links");
